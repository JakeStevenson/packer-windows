...
cmd /c ""C:\Program Files\7-Zip\7z.exe" x C:\Windows\Temp\prl-tools-win.iso -oC:\Windows\Temp\prl-tools-win"
cmd /c C:\Windows\Temp\prl-tools-win\PTAgent.exe /install_silent
goto :done
